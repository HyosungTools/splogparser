   ...
   [TestClass]
    public class SignalRTests
    {
      ...
      public void SignalRConnectionState_Established()
      {
         ...
         Assert.IsNull(line.ConnectionUrl);
      ...
      public void SignalRConnectionState_Reconnected()
      {
         ...
         Assert.AreEqual("http://10.37.152.15:81/activeteller/signalr/", line.ConnectionUrl);
      ...
      public void SignalRConnectionState_FailedToConnect()
      {
         ...
         Assert.AreEqual("192.168.5.33:80", line.ConnectionUrl);
