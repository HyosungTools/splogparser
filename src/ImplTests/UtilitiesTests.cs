...
namespace ImplTests
{
   ...
   public class UtilitiesTests
   {
      ...
      public void GetTimeFromLogLineSuccess()
      {
         ...
         string logTime = Utilities.GetTimeFromLogLine(logLine);
      ...
      public void FindMarkerInLogLineFail()
      {
         ...
         var result = Utilities.FindByMarker(logLine, "Shutter Open = [", 1);
         Assert.IsTrue(string.IsNullOrEmpty(result.foundStr));
      ...
      public void FindMarkerInLogLineSuccess()
      {
         ...
         Assert.IsTrue(result.foundStr.Equals("0"));
         Assert.IsTrue(logLine.Length > result.subLogLine.Length);
         Assert.IsTrue(result.subLogLine.StartsWith("]"));
      }
      [TestMethod]
      public void FindMarkerInLogLineFail2()
      {
         ...
         var result = Utilities.FindByMarker(logLine, "{", "}");
         Assert.IsTrue(string.IsNullOrEmpty(result.foundStr));
         Assert.IsTrue(logLine.Length == result.subLogLine.Length);
      }
      [TestMethod]
      public void FindMarkerInLogLineSuccess2()
      {
         ...
         var result = Utilities.FindByMarker(logLine, "{", "}");
         Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
         Assert.IsFalse(logLine.Length == result.subLogLine.Length);
      }
      [TestMethod]
      public void FindByBracketFailNoMatch()
      {
         ...
         var result = Utilities.FindByBracket(logLine, '{', '}');
      ...
      public void FindByBracketSuccess()
      {
         ...
         (bool found, string foundStr, string subLogLine) result = Utilities.FindByBracket(logLine, '{', '}');
         Assert.IsTrue(result.found);
         Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
         Assert.IsFalse(result.subLogLine.Contains("{"));
         Assert.IsFalse(result.subLogLine.Contains("}"));
      }
      ...
      public void FindByBracketSuccessNested()
      {
         ...
         result = Utilities.FindByBracket(result.foundStr, '{', '}');
         Assert.IsTrue(result.found);
         Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
      ...
      public void FindCstsInHCDUSensorLogLine()
      {
         ...
         for (int i = 1; i <= 6; i++)
         {
            result = Utilities.FindByMarker(logLine, "Missing = [", 1);
            Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
            Assert.IsTrue(logLine.Length > result.subLogLine.Length);

            logLine = result.subLogLine;

            result = Utilities.FindByMarker(logLine, "Empty = [", 1);
            Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
            Assert.IsTrue(logLine.Length > result.subLogLine.Length);

            logLine = result.subLogLine;

            result = Utilities.FindByMarker(logLine, "Low = [", 1);
            Assert.IsFalse(string.IsNullOrEmpty(result.foundStr));
            Assert.IsTrue(logLine.Length > result.subLogLine.Length);
         }
      }
      ...
      public void FindNextLineSuccess()
      {
         ...
         (bool found, string oneLine, string subLogLine) nextLine = Utilities.ReadNextLine(logLine);
      ...
      public void FindLineSuccess()
      {
         ...
         (bool found, string oneLine, string subLogLine) nextLine = Utilities.FindLine(logLine, "[801]");
         Assert.IsTrue(nextLine.found);
      ...
      public void FindLineFail()
      {
         ...
         (bool found, string oneLine, string subLogLine) nextLine = Utilities.FindLine(logLine, "[000]");
         Assert.IsFalse(nextLine.found);
         Assert.IsTrue(string.IsNullOrEmpty(nextLine.oneLine));
