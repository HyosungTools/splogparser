...
namespace Impl
{
    ...
    public static class Utilities
    {
        ...
        public static (bool found, string oneLine, string subLogLine)  ReadNextLine(string logLine)
        {
            ...
            bool found = !(string.IsNullOrEmpty(oneLine) || !string.IsNullOrWhiteSpace(oneLine));
            if (found)
            {
                subLogLine = oneLine.Substring(subLogLine.Length);
                return (found, oneLine, subLogLine);
            }
            return (found, string.Empty, subLogLine);
        }
