...
namespace Impl
{
   ...
   public class Context : IContext
   {
      ...
      // Dataset holding the tables generated by the views
      public DataSet combinedDataSet { get; set; }
      ...
      /// <param name="zipFileName">name of the zip file to operate on</param>
      public Context(IFileSystemProvider ioProvider, ILogger logger, string workFolder, string subFolder, string zipFileName, IOptions opts)
      {
         ...
         this.opts = opts;
         this.combinedDataSet = new DataSet();
      }
