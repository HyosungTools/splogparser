...
namespace LogFileHandler
{
   ...
   public class AVLogHandler : LogHandler, ILogFileHandler
   {
      ...
      {
         LogExpression = "ActiveTellerServer*.*";
      ...
      public ILogLine IdentifyLine(string logLine)
      {
         if (logLine.StartsWith("============"))
         {
            ...
            // ignore
            return new AVLine(this, logLine, AVLogType.None);
         }
         ...
         if (logLine.Contains("[Settings            ]"))
         {
            ...
            return new Settings(this, logLine, AVLogType.Settings);
         }
         ...
         if (logLine.Contains("[StringResourceManager]"))
         {
            ...
            return new StringResourceManager(this, logLine, AVLogType.StringResourceManager);
         }
         ...
         if (logLine.Contains("[BeeHDVideoControl   ]"))
         {
            ...
            return new BeeHDVideoControl(this, logLine, AVLogType.BeeHDVideoControl);
         }
         ...
         if (logLine.Contains("[VideoManager        ]"))
         {
            ...
            return new VideoManager(this, logLine, AVLogType.VideoManager);
         }
         ...
         if (logLine.Contains("[SignInManager       ]"))
         {
            ...
            return new SignInManager(this, logLine, AVLogType.SignInManager);
         }
         ...
         if (logLine.Contains("[PermissionsManager  ]"))
         {
            ...
            return new PermissionsManager(this, logLine, AVLogType.PermissionsManager);
         }
         ...
         if (logLine.Contains("[MainWindow          ]"))
         {
            ...
            return new MainWindow(this, logLine, AVLogType.MainWindow);
         }
         ...
         if (logLine.Contains("[IdleEmpty           ]"))
         {
            ...
            return new IdleEmpty(this, logLine, AVLogType.IdleEmpty);
         }
         ...
         if (logLine.Contains("[ConnectionManager   ]"))
         {
            ...
            return new ConnectionManager(this, logLine, AVLogType.ConnectionManager);
         }
         ...
         if (logLine.Contains("[DataFlowManager     ]"))
         {
            ...
            return new DataFlowManager(this, logLine, AVLogType.DataFlowManager);
         }
         ...
         if (logLine.Contains("[DeviceFactory       ]"))
         {
            ...
            return new DeviceFactory(this, logLine, AVLogType.DeviceFactory);
         }
         */
