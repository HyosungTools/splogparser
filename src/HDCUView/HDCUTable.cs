...
namespace HDCUView
{
    ...
    internal class HDCUTable : BaseTable
    {
        ...
        {
            Console.WriteLine("HDCUTable constructor");
            ...
            Console.WriteLine("HDCUTable constructor complete");

        }

        protected override void InitDataTable()
        {
            Console.WriteLine("HDCUView.InitDataTable");
            base.InitDataTable();
            ...
            Console.WriteLine("HDCUView.InitDataTable complete");
